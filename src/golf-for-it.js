...
export class GolfForIt extends Scene {
    constructor() {
        ...
        // GameObjects
        this.game_objects = {
            golf_ball: new GameObject({ has_rigidbody: true, shape: this.shapes.sphere }),
            ground: new GameObject({ size: vec3(100, 1, 100), position: vec3(0, -2, 0), material: this.materials.ground }),
            obstacle: new GameObject({ size: vec3(2, 2, 2), position: vec3(0, 1, -20), material: this.materials.obstacle }),
            left_wall: new GameObject({ size: vec3(1, 2, 30), position: vec3(-10, 1, -15), material: this.materials.obstacle }),
            right_wall: new GameObject({ size: vec3(1, 2, 12), position: vec3(10, 1, 2), material: this.materials.obstacle }),
            left_wall2: new GameObject({ size: vec3(30, 2, 1), position: vec3(20, 1, -44), material: this.materials.obstacle }),
            right_wall2: new GameObject({ size: vec3(21, 2, 1), position: vec3(30, 1, -10), material: this.materials.obstacle }),
            back_wall: new GameObject({ size: vec3(1, 2, 17), position: vec3(50, 1, -27), material: this.materials.obstacle })
        };
    ...
    make_control_panel() {
        ...
        this.key_triggered_button(
            ...
            ["a"],
            () => {
                if (this.game_objects.golf_ball.rigidbody.velocity.norm() === 0) {
    ...
    make_camera_follow_ball(program_state) {
        ...
        let camera = Mat4.inverse(model_transform.times(Mat4.rotation(0.3, -1, 0, 0).times(Mat4.translation(0, 0, 20))));
